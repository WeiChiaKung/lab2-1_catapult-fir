...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /usr/cadtool/mentor/Questa_Sim/2021.1_1/questasim/bin
...
OSCI_AC_FIXED_VRA_FILE_NAME                         := vra.csv
...
Novas_NOVAS_INST_DIR                                := /usr/cad/synopsys/verdi/2022.06
...
ifeq "$(VCS_VCS_HOME)" ""
VCS_VCS_HOME                                        := /usr/cad/synopsys/vcs/2022.06
export VCS_VCS_HOME
endif
...
ifeq "$(VSCode_INSTALL)" ""
VSCode_INSTALL                                      := /home/m112/m112061621/soc_lab2-1/catapult-for-soc-course/lab1_fir/01_walkthrough_loops
export VSCode_INSTALL
endif
ifeq "$(VSCode_GDB_PATH)" ""
VSCode_GDB_PATH                                     := /bin/gdb
export VSCode_GDB_PATH
endif
...
ifeq "$(OasysRTL_VthHighMarker)" ""
OasysRTL_VthHighMarker                              := 
export OasysRTL_VthHighMarker
endif
ifeq "$(OasysRTL_VthLowMarker)" ""
OasysRTL_VthLowMarker                               := 
export OasysRTL_VthLowMarker
endif
ifeq "$(OasysRTL_VthConstraintPercent)" ""
OasysRTL_VthConstraintPercent                       := 
export OasysRTL_VthConstraintPercent
endif
...
ifeq "$(OasysRTL_EnableResizing)" ""
OasysRTL_EnableResizing                             := false
export OasysRTL_EnableResizing
endif
...
ifeq "$(OasysRTL_TuningParams)" ""
OasysRTL_TuningParams                               := 
export OasysRTL_TuningParams
endif
ifeq "$(OasysRTL_ForceLegacyParsing)" ""
OasysRTL_ForceLegacyParsing                         := false
export OasysRTL_ForceLegacyParsing
endif
